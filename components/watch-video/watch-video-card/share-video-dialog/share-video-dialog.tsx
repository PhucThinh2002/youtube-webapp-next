        ...
        <div className={styles.shareDialog}>
          <div>
            <div className={styles.shareDialogHeader}>
              <h2 className={`${styles.shareDialogHeader__title} mat-h2`}>
                Share
              </h2>
              <div
                className={styles.shareDialogHeader__close}
            ...
            <div className={styles.dialogInput}>
              <TextField
                value={videoUrl}
                sx={texfieldStyles}
                className={styles.dialogInput__field}
                variant="filled"
              />
              <Button
                className={styles.dialogInput__suffix}
                sx={{ fontSize: "1.4rem" }}
                onClick={onCopyUrl}
              >
                COPY

import { AccountCircle, Diamond, Keyboard, NightlightRounded, ShowChart, VideoSettings} from "@mui/icons-material";
...
export default function AccountSidebar() {
  ...
  const [appearanceMenuAnchor, setAppearanceMenuAnchor] =
      ...
      <div className={styles.sidebar}>
        ...
        <div className={styles.sidebarContent}>
          ...
          <Button className={styles.sidebarContentItem}>
            ...
            <a
              href="https://github.com/PhucThinh2002/youtube-webapp-next"
              target="_blank"
